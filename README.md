...
Приложение на Python для работы с электронной почтой через протоколы SMTP и IMAP. Предоставляет чистый объектно-ориентированный интерфейс для отправки и получения писем с поддержкой Gmail и других почтовых сервисов.
...
- Совместимость с Gmail: Предварительно настроен для Gmail (можно настроить для других почтовых систем)
